                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url(); ?>peminjaman/balik"/><button class="btn btn-primary">Tambah</button></a>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php foreach($join as $pinjam): ?>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>peminjaman/detail_transaksi/<?php echo $pinjam->kode_transaksi; ?>"><i class="btn-sm btn-success">Detail</i></a>
                        </td>
