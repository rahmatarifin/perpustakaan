                        ...
                        <form action="<?php echo base_url(); ?>peminjaman/pinjam/" method="post">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-6">
                              <input type="searc" id="text-input" name="nama_anggota" placeholder="Nama Anggota" class="form-control">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3">
                              <input type="text" id="text-input" name="tanggal_pinjam" class="form-control" value="" >
                              <small class="form-text text-muted">Tanggal Peminjaman Buku</small>
                            </div>
                          
                            <div class="col-12 col-md-3">
                              <input type="text" id="text-input" name="tanggal_kembali" class="form-control">
